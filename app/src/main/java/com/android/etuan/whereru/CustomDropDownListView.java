...
public class CustomDropDownListView extends LinearLayout {
    ...
    public CustomDropDownListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // TODO Auto-generated constructor stub
    }

    public CustomDropDownListView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param list
     */
    public void setItemsData(String defaultString,ArrayList<String> list) {
        dataList = list;

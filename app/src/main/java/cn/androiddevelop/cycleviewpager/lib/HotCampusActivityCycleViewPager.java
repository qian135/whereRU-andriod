...
@SuppressLint("NewApi")
public class HotCampusActivityCycleViewPager extends Fragment implements OnPageChangeListener {
	
	private List<ImageView> imageViews = new ArrayList<>();
	private ImageView[] indicators;
	private FrameLayout viewPagerFragmentLayout;
	private LinearLayout indicatorLayout; // 指示器
	private HotCampusActivityBaseViewPager viewPager;
	private HotCampusActivityBaseViewPager parentViewPager;
	private ViewPagerAdapter adapter;
	private HotCampusActivityCycleViewPagerHandler handler;
	...
	private List<HotCampusActivityInformation> infos;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		viewPager = (HotCampusActivityBaseViewPager) view.findViewById(R.id.viewPager);
		...
		handler = new HotCampusActivityCycleViewPagerHandler(getActivity()) {
	...
	public void setData(List<ImageView> views, List<HotCampusActivityInformation> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<HotCampusActivityInformation> list, ImageCycleViewListener listener, int showPosition) {
	 ...
	 * @return viewPager
	 */
	public HotCampusActivityBaseViewPager getViewPager() {
		return viewPager;
	}
	 ...
	 */
	public void disableParentViewPagerTouchEvent(HotCampusActivityBaseViewPager parentViewPager) {
		if (parentViewPager != null)
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(HotCampusActivityInformation info, int postion, View imageView);
	}
}